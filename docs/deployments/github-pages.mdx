...
GitHub Pages automatically builds and serves content from specific branches (`gh-pages`, `master`, `main`, or `docs/` folders depending on settings).  
...
This workflow ensures that every commit to your chosen deployment branch automatically rebuilds and deploys your JSON endpoints to GitHub Pages.
