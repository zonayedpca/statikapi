...
- using the Vercel CLI from the output directory:
  ```bash
  vercel --cwd api-out --prod
  ```

If `api-out/` is the project root for a static deployment, the CLI can publish it directly.
