...
- Public Static Assets are generated by `statikapi-cf build` and require a fresh deploy to change.
...
> Targeted rebuilds for public routes are rejected, because public routes are emitted as Static Assets during the local build step.
