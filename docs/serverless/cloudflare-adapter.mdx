...
- The Worker serves public requests through its `ASSETS` binding and serves private requests from private storage.
...
6. **Serves private reads from R2 and public reads from `env.ASSETS`**
